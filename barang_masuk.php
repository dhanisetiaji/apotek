<?php
    ...
    <a href="dashboard.php">Go Back</a>
        ...
        if(isset($_GET['del'])){
            $id=$_GET['del'];
            $sql1 = "delete from detail_barang_masuk WHERE id_barang_masuk=:id";
              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <td>
                    <a type="button" class="btn btn-sm btn-secondary" href="detail_barang_masuk.php?id=<?php echo $res->id;?>"><i class="fas fa-info-circle"></i></a>
                        <a type="button" class="btn btn-sm btn-primary" href="edit_barang_masuk.php?id=<?php echo $res->id;?>"><i class="fas fa-edit"></i></a>
                         <a href="barang_masuk.php?del=<?php echo $res->id;?>" onclick="return confirm('Do you want to delete');" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                            <?php $nmr=$nmr+1; } } ?>
                            </tbody>
