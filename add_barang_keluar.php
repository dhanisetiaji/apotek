<?php
    ...
    <a href="dashboard.php">Go Back</a>
        ...
        $sql = "select max(id_barang_keluar) as kodeTerbesar FROM detail_barang_keluar";
        ...
        if(isset($_POST['tambah'])){
            ...
            $query = "INSERT INTO detail_barang_keluar(id_barang_keluar,id_barang,id_supplier,jumlah,harga_beli,expired) VALUES(:id_barang_keluar,:id_barang,:id_supplier,:jumlah,:harga_beli,:expired)";
            ...
            $tgl = $_POST['tgl'];
            $total_harga = $total;
            $qtambah = "INSERT INTO barang_keluar(id,id_pegawai,tgl,total_harga) VALUES(:id,:id_pegawai,:tgl,:total_harga)";
            ...
            $tambah -> execute();
            $msg = "Barang keluar berhasil di tambah!";
...
<head>
  ...
  <title>Apotek | Add Barang Keluar</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Menu Barang Keluar</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="col">
                  <div class="card card-default">
                      <div class="card-header">
                          <h3 class="card-title">Detail Barang Keluar <button type="button" class="btn btn-sm btn-secondary" id="btn-tambah-form"><i class="nav-icon fas fa-plus"></i> Tambah Data Form</button> <button type="button" class="btn btn-sm btn-danger" id="btn-reset-form">Reset Form</button></h3>
                          ...
                          <div class="row">
                              <div class="col-md-6">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" id="jumlah" name="id_supplier[]" class="form-control" required>
                                  </div>
                              </div>
                              <div class="col-md-6">
                                  <div class="form-group">
