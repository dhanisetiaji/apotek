              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  <?php 
                        ...
                        // var_dump($tgl);
                        // die();
                        $sql = "select * from detail_barang_masuk WHERE expired<=:tgl";
                  ...
                  <tr>
                    ...
                    <td><?php echo htmlentities($res->id_barang);?></td>
                    <td><?php echo htmlentities($res->jumlah);?></td>
                    <td><?php echo rupiah($res->harga_beli);?></td>
                    <td><?php echo htmlentities($res->expired);?></td>
                    <td>
                    <a type="button" target="_blank" class="btn btn-sm btn-secondary" href="print_barang_expired.php?id=<?php echo $res->id_detail;?>"><i class="fas fa-print"></i></a> </td>
                  </tr>
                            <?php $nmr=$nmr+1; } } ?>
                            </tbody>
                            </table>
