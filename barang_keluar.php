<?php
    ...
    <a href="dashboard.php">Go Back</a>
        ...
        if(isset($_GET['del'])){
            $id=$_GET['del'];
            $sql1 = "delete from detail_barang_keluar WHERE id_barang_keluar=:id";
    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <div class="card">
              ...
              <a type="button" class="btn btn-sm btn-primary" href="add_barang_keluar.php"><i class="fas fa-plus"></i> Tambah Barang Keluar</a><br>
                <?php 
                    if($error){
                ?>
              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <td><?php echo htmlentities($res->id_pegawai);?></td>
                    <td><?php echo htmlentities($res->tgl);?></td>
                    <td><?php echo rupiah($res->total_harga);?></td>
                    <td>
                    <a type="button" class="btn btn-sm btn-secondary" href="detail_barang_keluar.php?id=<?php echo $res->id;?>"><i class="fas fa-info-circle"></i></a>
                        <a type="button" class="btn btn-sm btn-primary" href="edit_barang_keluar.php?id=<?php echo $res->id;?>"><i class="fas fa-edit"></i></a>
                         <a href="barang_keluar.php?del=<?php echo $res->id;?>" onclick="return confirm('Do you want to delete');" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                            <?php $nmr=$nmr+1; } } ?>
                            </tbody>
