...
<head>
  ...
  <title>Apotek | Print Barang Hampir Habis</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Menu Print Barang Hampir Habis</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  <?php 
                        ...
                        $sql = "SELECT * from obat_alkes INNER JOIN kategori ON obat_alkes.id_kategori=kategori.id_kat where obat_alkes.stok<=10";
                  ...
                  <tr>
                    ...
                    <td>
                    <a type="button" target="_blank" class="btn btn-sm btn-secondary" href="print_hampir_habis.php?id=<?php echo $res->id;?>"><i class="fas fa-print"></i></a> </td>
                  </tr>
                            <?php $nmr=$nmr+1; } } ?>
                            </tbody>
                            </table>
