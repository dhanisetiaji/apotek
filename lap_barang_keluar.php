  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Menu Print Barang Keluar</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <td>
                    <a type="button" target="_blank" class="btn btn-sm btn-secondary" href="print_barang_keluar.php?id=<?php echo $res->id;?>"><i class="fas fa-print"></i></a>
                    </td>
                  </tr>
                            <?php $nmr=$nmr+1; } } ?>
                            </tbody>
